...
*/
	...
	add_menu_page('', 'My Plugin', 'administrator', MYPLUGIN_NAME, 'swpframework_submenu_welcome', $icon_url) ;
...
function swpframework_submenu_welcome() {
  ...
  echo '<div class="wrap">';
  echo '<div id="icon-swpframework" class="icon32"><img src="'. $icon_url . '"></div><h2>Welcome (Sublevel Page #1)</h2>';
...
function swpframework_submenu_2() {
  ...
  echo '<div class="wrap">';
  echo '<div id="icon-swpframework" class="icon32"><img src="'. $icon_url . '"></div><h2>Sublevel Page #2</h2>';
...
function swpframework_submenu_3() {
  ...
  echo '<div class="wrap">';
  echo '<div id="icon-swpframework" class="icon32"><img src="'. $icon_url . '"></div><h2>Sublevel Page #3</h2>';
  echo '<p>Welcome to sublevel page 3.  You can place HTML code, include/require a PHP file, or call a function function from this area.</p>';
  echo '</div>';
...
function swpframework_submenu_4() {
  ...
  echo '<div class="wrap">';
  echo '<div id="icon-swpframework" class="icon32"><img src="'. $icon_url . '"></div><h2>Sublevel Page #4</h2>';
  echo '<p>Welcome to sublevel page 4.  You can place HTML code, include/require a PHP file, or call a function function from this area.</p>';
  echo '</div>';
...
function swpframework_submenu_5() {
  ...
  echo '<div class="wrap">';
  echo '<div id="icon-swpframework" class="icon32"><img src="'. $icon_url . '"></div><h2>Sublevel Page 5</h2>';
...
function swpframework_submenu_options() {
  ...
  swpframework_options_page();  ## Calls a function located in the options.php file. You will find different
