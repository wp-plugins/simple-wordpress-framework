...
This section handles activation of plugin.  Creates/Updates database Tables, and it will
allow the plugin to create tables, and insert default data into the tables.

*/

function swpframework_activate() {
	...
	if ( $installed_ver != MYPLUGIN_VERSION ) {
		...
		if ($new_installation)
		{
			swpframework_default_table_data ();

		}

		swpframework_default_options ();
		
	}
}

function swpframework_default_table_data() {
