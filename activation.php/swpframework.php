...
/*  Copyright YEAR  PLUGIN_AUTHOR_NAME  (email : PLUGIN AUTHOR EMAIL)
	...
	** What Plugin features are supported? **
	...
	5. 	Use of AJAX/jQuery/JavaScript Components:
		...
		b) 500+ Icons - 16 x 16 and 32 x 32 that can be used in your Plugin ( http://www.swpframework.com/icon-gallery/ ) 
		   214 Tango Theme Icons (16 x 16) and (32 x 32) from FreeDesktop.org ( http://tango.freedesktop.org/Tango_Icon_Library ). 
		   There are plenty of icons available on the web, all you have to do is search for them.  The best resolution comes from 
		   icons that are "*.ico" files.  This is because Icons from .ico files have been designed with 16, 22, 32, 64, etc so they 
		   will always display properly. If you use Photoshop you'll need an .ico converter, Telegraphics offers 
		   a free add-on: http://www.telegraphics.com.au/sw/
	...
	** Upcoming Features **
	...
	3. Database Table: List, View and Edit - Allows you to add, remove, edit, view data from a new database file (release date: 02/01/2010).
    ...
    5. Publish your plugin at WordPress: Plugin Submission and Promotion ( http://codex.wordpress.org/Plugin_Submission_and_Promotion ) - Once you have written your plugin, here are some hints on distributing it widely.
    6. Publish your plugin at WP-plugins.net - http://wp-plugins.net/doc/developers/
    7. Publish your plugin at WP-Plugins.org - http://plugins.trac.wordpress.org/
