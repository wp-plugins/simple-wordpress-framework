...
/*  Copyright YEAR  PLUGIN_AUTHOR_NAME  (email : PLUGIN AUTHOR EMAIL)
   ...
   =============
	...
	1.	Change the Standard Plugin Information Header at the beginning of the `myplugin.php` file, 
	...
	3.	Choose a <FILE/FUNCTION> name for this Plugin, the current name is 'myplugin'.  Make sure you
	...
	4.	Use your PHP editor and perform the following tasks to all the files within you Plugin directory.  
		...
		- Perform a 'Find and Replace' with 'Match Case' checked, and replace all 
		  instances of 'myplugin' with the new NAME of your Plugin.
	5. 	Rename the file names below with your new <FILE/FUNCTION> name.
		- 'myplugin.php' --> <FILE/FUNCTION>.php
		- 'myplugin.farbtastic.js' -> <FILE/FUNCTION>.farbtastic.js
	...
	7. 	Upload the 'myplugin' folder to the '/wp-content/plugins/' directory
	8. 	Rename the 'myplugin' of this Plugin from 'myplugin' with your new <FILE/FUNCTION> name.
...
define( 'MYPLUGIN_FILE_PATH', __FILE__);
...
require_once( MYPLUGIN_PATH . 'load-css-and-js.php' );
require_once( MYPLUGIN_PATH . 'functions.php' );
require_once( MYPLUGIN_PATH . 'menus.php' );
require_once( MYPLUGIN_PATH . 'pages/options.php' );

register_activation_hook(__FILE__,'myplugin_activate');  // WordPress Hook that executes the installation
register_deactivation_hook( __FILE__, 'myplugin_deactivate' ); // WordPress Hook that handles deactivation of the Plugin.

add_action('plugins_loaded', 'myplugin_check_for_updates' );   // Checks if this plugin is an update from a previous version.
